...
class AttackList extends React.Component {
  ...
  listenToEvent = () => {
    this.props.contract.events
      .SuccessAttack({
        filter: {
          _attackingPuppyId: this.state.attackingPuppyId,
          _targetedPuppyId: this.state.targetPuppyId,
        },
      })
          ...
          <div className="row ml-2 centreRow">
            <div className="form-group col-md-4 ml-2">
              ...
              <select
                ...
                id="myPuppies"
                name="attackingPuppyId"
                value={this.state.attackingPuppyId}
            ...
            <div className="form-group col-md-4">
              ...
              <select
                ...
                id="otherPuppies"
                name="targetPuppyId"
                value={this.state.targetPuppyId}
                onChange={this.handleInputChange}
                required
              >
                {otherPuppiesList}
